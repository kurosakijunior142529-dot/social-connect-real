...
import { ExternalLink, Info, Wifi, Crown, ArrowLeft } from "lucide-react";
  ...
  return (
    <div className="px-4 pt-2 pb-10">
      ...
      <section className="mt-5 space-y-3">
        ...
        <div className="flex gap-3 rounded-3xl bg-[color:var(--surface)] p-4">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              A Microsoft não permite que o jogo rode dentro de outros apps, então ele abre em uma nova aba do
              navegador. É só voltar ao vibely quando terminar.
            </p>
          </div>
        </div>
      </section>
      ...
      <div className="mt-5 grid grid-cols-2 gap-3">
        <a
          href="https://www.xbox.com/xbox-game-pass/cloud-gaming"
          target="_blank"
          rel="noopener noreferrer"
